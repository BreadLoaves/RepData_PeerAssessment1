...
library(knitr)
library(here)
here("C:/Users/alexa/PycharmProjects/Rstuff/activity.csv")
unzip("activity.zip")
...
```{r}
Stepstaken <- aggregate(steps ~ date, data, sum)
hist(Stepstaken$steps, xlab = paste("Steps taken per day"), col = 'red', main = "Total steps per day")
mean <- mean(Stepstaken$steps)
mean
median <- median(Stepstaken$steps)
median
```
